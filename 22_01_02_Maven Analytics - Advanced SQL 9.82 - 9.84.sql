...
FROM(
	SELECT
		sessions_cart.time_period,
		sessions_cart.cart_session_id,
		CASE WHEN cart_another_page IS NULL THEN 0 ELSE 1 END AS clicked_another_page,
		CASE WHEN pre_post_orders.order_id IS NULL THEN 0 ELSE 1 END AS placed_order,
